      ...
      >
        ...
        <div className="px-2 pb-4 border-t border-border pt-4 space-y-1 flex-shrink-0">
          ...
          >
            {mounted
              ? isDark
                ? <Sun size={18} className="flex-shrink-0 text-yellow-400" />
                : <Moon size={18} className="flex-shrink-0" />
              : <Moon size={18} className="flex-shrink-0 opacity-40" />
            }
            <span
              className={`flex-1 whitespace-nowrap transition-all duration-300 ${sidebarOpen ? "opacity-100" : "opacity-0 w-0 overflow-hidden lg:hidden"
                }`}
            ...
            {sidebarOpen && mounted && (
              <span
                className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-full transition-colors flex-shrink-0 ${isDark
